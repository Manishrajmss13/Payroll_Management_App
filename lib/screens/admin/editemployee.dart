...
class _EditEmployeePageState extends State<EditEmployee> {
  // Form controllers with pre-defined values
  ...
  final TextEditingController _basicPayController = TextEditingController(text: "50000");

  // State variables with pre-defined values
  int _age = 30;
