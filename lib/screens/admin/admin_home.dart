...
import 'package:payroll_system/screens/admin/view_attendance.dart';
...
class AdminHome extends StatelessWidget {
                      ...
                      _buildGradientButton(
                        ...
                        _buildGradientButton(
                          ...
                          onPressed: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const ManageRequestPage(),
                            ),
                          ),
                        ),
                      ],
  ...
  Widget _buildGradientButton(String label,
      {bool isWide = false, required VoidCallback onPressed}) {
    return Container(
